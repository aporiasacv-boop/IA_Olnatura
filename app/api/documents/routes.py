"""
Endpoints RAG para indexación y consulta de documentos.
"""
...
@router.post(
    ...
    summary="Indexar documento PDF o DOCX",
    tags=["Documents"],
)
async def index_document(
    file: UploadFile = File(..., description="Archivo PDF o DOCX a indexar"),
    service: RAGService = Depends(get_rag_service),
) -> DocumentIndexResponse:
    """
    Indexa un documento empresarial en ChromaDB mediante LangChain.
    ...
    if not file.filename:
        raise HTTPException(
            ...
            detail="El archivo debe incluir nombre.",
        )
...
@router.post(
    ...
    summary="Consultar documentos indexados (RAG)",
    tags=["Documents"],
)
def query_documents(
    ...
    """
    Consulta documentos indexados usando recuperación semántica (RAG).

    Recupera fragmentos relevantes de ChromaDB y genera respuesta con Ollama.
    """
    ...
    return DocumentQueryResponse(
        ...
        sources=[
            SourceChunkResponse(content=source.content, metadata=source.metadata)
