...
@router.get('/health', response_model=DynamicsHealthResponse, summary='Verificar conexión a Dynamics 365 F&O', tags=['Dynamics'])
def dynamics_health_check(client: DynamicsClientDep) -> DynamicsHealthResponse:
    ...
    if not service.is_connected():
        ...
        raise HTTPException(status_code=status.HTTP_503_SERVICE_UNAVAILABLE, detail='Dynamics unavailable')
