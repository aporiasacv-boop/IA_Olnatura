"""
Pruebas de transformadores ETL.
"""
...
def test_transform_clientes_maps_fields() -> None:
    """Verifica mapeo de CustomersV3 a tabla clientes."""
    records = [
        {
            "CustomerAccount": "C001",
            "OrganizationName": "Olnatura SA",
            "PrimaryContactEmail": "info@olnatura.com",
        },
...
def test_transform_ventas_maps_fields() -> None:
    """Verifica mapeo de SalesOrderHeadersV2 a tabla ventas."""
    records = [
        {
            "SalesOrderNumber": "SO-100",
            "OrderingCustomerAccountNumber": "C001",
            "SalesOrderTotalAmount": 500.25,
            "RequestedShippingDate": "2025-01-15",
