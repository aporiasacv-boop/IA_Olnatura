"""
Pruebas del generador de prompt empresarial.
"""
...
def test_build_business_summary_prompt_includes_data() -> None:
    """Verifica que el prompt incluye los indicadores de entrada."""
...
def test_build_business_summary_prompt_includes_interpretation_rules() -> None:
    """Verifica reglas estrictas: solo interpretar, sin recomendar ni decidir."""
