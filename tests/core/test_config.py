...
def test_d365_oauth_scope_is_derived_from_base_url() -> None:
    config = Settings(D365_BASE_URL='https://prod.operations.dynamics.com/data', D365_OAUTH_SCOPE='')
...
def test_d365_token_url_is_derived_from_tenant_id() -> None:
    config = Settings(D365_TENANT_ID='abc-123', D365_TOKEN_URL='')
    assert config.d365_token_url == 'https://login.microsoftonline.com/abc-123/oauth2/v2.0/token'
