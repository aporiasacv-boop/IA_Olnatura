...
def mock_dynamics_client() -> MagicMock:
    client = MagicMock()
    client.fetch_all_entity.side_effect = lambda entity, page_size=100: {'CustomersV3': [{'CustomerAccount': 'C001', 'OrganizationName': 'Cliente Uno SA', 'PrimaryContactEmail': 'uno@olnatura.com', 'PrimaryContactPhone': '555-0001'}, {'CustomerAccount': 'C002', 'NameAlias': 'Cliente Dos', 'PrimaryContactEmail': 'dos@olnatura.com'}], 'SalesOrderHeadersV2': [{'SalesOrderNumber': 'SO-001', 'OrderingCustomerAccountNumber': 'C001', 'SalesOrderTotalAmount': 1500.5, 'RequestedShippingDate': '2025-06-01', 'SalesOrderStatus': 'Open'}, {'SalesOrderNumber': 'SO-002', 'OrderingCustomerAccountNumber': 'C002', 'SalesOrderTotalAmount': 3200.0, 'OrderCreationDateTime': '2025-06-10T10:00:00Z', 'SalesOrderStatus': 'Delivered'}]}.get(entity, [])
    return client
